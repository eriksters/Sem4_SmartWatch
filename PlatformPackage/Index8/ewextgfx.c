...
/* The color format of the framebuffer has to correspond to color format of the
  ...
  #error The given EW_FRAME_BUFFER_COLOR_FORMAT is not supported! Use Index8 within your makefile or project!
#endif
  ...
  void* aDisplay1, void* aDisplay2, void* aDisplay3 )
{
  ...
  viewport->FrameBuffer->BytesPerPixel = sizeof( char );
  ...
  viewport->FrameBuffer->Clut          = 0;
    ...
    viewport->DoubleBuffer->BytesPerPixel = sizeof( char );
