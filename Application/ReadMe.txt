...
*   target.
*
*   This package is prepared and tested for the STM32F469 Discovery board.
*
*******************************************************************************/

Getting started with STM32F469 Discovery board:
-----------------------------------------------
...
How to build a demo using this template for the STM32F469 Discovery board:
--------------------------------------------------------------------------
